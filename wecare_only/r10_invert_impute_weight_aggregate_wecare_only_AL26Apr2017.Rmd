...
- Get crude aggregated counts per gene for all cases and for sub-groups 
...
invert and aggregate kgen and exac data per gene ?
...
Also records if multilaalelic or inverted variant is preswent in a gene.  
...
genes_aggr_info.df <- as.data.frame(genes_aggr_info.mx)
genes_aggr_info.df$gene <- as.vector(genes_aggr_info.df$gene)
genes_aggr_info.df$num_var <- as.numeric(as.vector(genes_aggr_info.df$num_var))

genes_aggr_info.df$inverted <- as.logical(as.vector(genes_aggr_info.df$inverted))
genes_aggr_info.df$multiallelic <- as.logical(as.vector(genes_aggr_info.df$multiallelic))

genes_aggr_info.df$aggr_ac <-as.numeric(as.vector(genes_aggr_info.df$aggr_ac))
genes_aggr_info.df$aggr_an <-as.numeric(as.vector(genes_aggr_info.df$aggr_an))
genes_aggr_info.df$aggr_af <-as.numeric(as.vector(genes_aggr_info.df$aggr_af))

genes_aggr_info.df$aggr_ac_cbc <-as.numeric(as.vector(genes_aggr_info.df$aggr_ac_cbc))
genes_aggr_info.df$aggr_an_cbc <-as.numeric(as.vector(genes_aggr_info.df$aggr_an_cbc))
genes_aggr_info.df$aggr_af_cbc <-as.numeric(as.vector(genes_aggr_info.df$aggr_af_cbc))

genes_aggr_info.df$aggr_ac_ubc <-as.numeric(as.vector(genes_aggr_info.df$aggr_ac_ubc))
genes_aggr_info.df$aggr_an_ubc <-as.numeric(as.vector(genes_aggr_info.df$aggr_an_ubc))
genes_aggr_info.df$aggr_af_ubc <-as.numeric(as.vector(genes_aggr_info.df$aggr_af_ubc))

genes_aggr_info.df$aggr_ac_cbc_fam <-as.numeric(as.vector(genes_aggr_info.df$aggr_ac_cbc_fam))
genes_aggr_info.df$aggr_an_cbc_fam <-as.numeric(as.vector(genes_aggr_info.df$aggr_an_cbc_fam))
genes_aggr_info.df$aggr_af_cbc_fam <-as.numeric(as.vector(genes_aggr_info.df$aggr_af_cbc_fam))

genes_aggr_info.df$aggr_ac_cbc_nofam <-as.numeric(as.vector(genes_aggr_info.df$aggr_ac_cbc_nofam))
genes_aggr_info.df$aggr_an_cbc_nofam <-as.numeric(as.vector(genes_aggr_info.df$aggr_an_cbc_nofam))
genes_aggr_info.df$aggr_af_cbc_nofam <-as.numeric(as.vector(genes_aggr_info.df$aggr_af_cbc_nofam))

genes_aggr_info.df$aggr_ac_ubc_fam <-as.numeric(as.vector(genes_aggr_info.df$aggr_ac_ubc_fam))
genes_aggr_info.df$aggr_an_ubc_fam <-as.numeric(as.vector(genes_aggr_info.df$aggr_an_ubc_fam))
genes_aggr_info.df$aggr_af_ubc_fam <-as.numeric(as.vector(genes_aggr_info.df$aggr_af_ubc_fam))

genes_aggr_info.df$aggr_ac_ubc_nofam <-as.numeric(as.vector(genes_aggr_info.df$aggr_ac_ubc_nofam))
genes_aggr_info.df$aggr_an_ubc_nofam <-as.numeric(as.vector(genes_aggr_info.df$aggr_an_ubc_nofam))
genes_aggr_info.df$aggr_af_ubc_nofam <-as.numeric(as.vector(genes_aggr_info.df$aggr_af_ubc_nofam))
...
save.image(paste(interim_data_folder, "s10_invert_impute_weight_aggregate_wecare_only.RData", sep="/"))
